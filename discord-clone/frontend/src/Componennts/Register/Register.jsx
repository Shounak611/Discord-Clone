...
function UserInfo({ text, inptype, value, onChange }) {
    return (
...
function PageLinks({ text, linkAddress }) {
    return (
        ...
        <form onSubmit={handleSubmit}>
            <div className="regformcontainerStyle">
                ...
                <div className="lowerregform">
                    ...
                    <button type="button" onClick={() => handleGoogleRegister()} className='googleBtnStyle'>
