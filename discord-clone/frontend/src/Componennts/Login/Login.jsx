            ...
            <div className='loginFormSection'>
                ...
                <form onSubmit={handleSubmit} className='loginForm'>
                    ...
                    <div className='registerPrompt'>
                        <span className='registerText'>Need an account?</span>
            ...
            <div className="googleAuthSection">
                <div className='googleContainerCard'>
                    ...
                    <div className='googleInfoText'>
                        ...
                        <p>Fast, secure, and passwordless authentication</p>
                        <button type="button" onClick={() => handleGoogleLogin()} className='googleLoginButton'>
